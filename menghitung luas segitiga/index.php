...
<head>
  <meta charset="UTF-8">
  <title>APLS3 - HARDI IRAWAN</title>
...
<body>
  ...
  <div id="apls3" class="form-action show">
    ...
    <form method="post" action="index.php">
      <ul>
        <li>
          <input type="text" name="alas" placeholder="Input alas" onkeypress="return HanyaAngkaYa(event)"  required/>
        </li>
        <li>
          <input type="text" name="tinggi" placeholder="Input tinggi" onkeypress="return HanyaAngkaYa(event)" required/>
        </li>
        <li>
  ...
  <div id="tentang" class="form-action hide">
    <h1>Tentang APLS3</h1>
    <p>APLS3 merupakan singkatan dari <strong>Aplikasi Perhitungan Luas Segitiga,</strong> APLS3 dibangun oleh <a href="https://facebook.com/abmujib" target="_blank" title="HARDI IRAWAN">HARDI IRAWAN</a> Tujuan dibangun aplikasi ini adalah untuk memenuhi salah satu tugas </a> <br><br>
